...
4. Implement the task fully (frontend, backend, API layer, database).
5. Add/Update Playwright/vitest tests if applicable.
6. Run all feedback loops (npm run typecheck, npm run test, npm run test:e2e, npm run lint, npm run build).
